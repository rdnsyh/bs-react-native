...
function CreateComponent(Impl) {
  ...
  var make = function (accessibilityLabel, accessible, hitSlop, onAccessibilityTap, onLayout, onMagicTap, responderHandlers, pointerEvents, removeClippedSubviews, style, testID, accessibilityComponentType, accessibilityLiveRegion, collapsable, importantForAccessibility, needsOffscreenAlphaCompositing, renderToHardwareTextureAndroid, accessibilityTraits, accessibilityViewIsModal, shouldRasterizeIOS, contentContainerStyle, horizontal, keyboardDismissMode, keyboardShouldPersistTaps, onContentSizeChange, onScroll, pagingEnabled, refreshControl, scrollEnabled, showsHorizontalScrollIndicator, showsVerticalScrollIndicator, stickyHeaderIndices, overScrollMode, scrollPerfTag, alwaysBounceHorizontal, alwaysBounceVertical, automaticallyAdjustContentInsets, bounces, canCancelContentTouches, centerContent, contentInset, contentOffset, decelerationRate, directionalLockEnabled, indicatorStyle, maximumZoomScale, minimumZoomScale, scrollEventThrottle, scrollIndicatorInsets, scrollsToTop, snapToAlignment, zoomScale) {
    var partial_arg = Props$BsReactNative.extendView(/* None */0, /* None */0, accessibilityLabel, accessible, hitSlop, onAccessibilityTap, onLayout, onMagicTap, responderHandlers, pointerEvents, removeClippedSubviews, style, testID, accessibilityComponentType, accessibilityLiveRegion, collapsable, importantForAccessibility, needsOffscreenAlphaCompositing, renderToHardwareTextureAndroid, accessibilityTraits, accessibilityViewIsModal, shouldRasterizeIOS, {
          ...
          keyboardDismissMode: Js_undefined.fromOption(UtilsRN$BsReactNative.option_map((function (x) {
                      if (x !== -453364557) {
                        if (x >= 1012481506) {
                          return "interactive";
                        } else {
          ...
          keyboardShouldPersistTaps: Js_undefined.fromOption(UtilsRN$BsReactNative.option_map((function (x) {
                      if (x !== -958984497) {
                        if (x >= 422592140) {
                          return "never";
                        } else {
          ...
          stickyHeaderIndices: Js_undefined.fromOption(UtilsRN$BsReactNative.option_map($$Array.of_list, stickyHeaderIndices)),
          ...
          alwaysBounceHorizontal: Js_undefined.fromOption(UtilsRN$BsReactNative.optBoolToOptJsBoolean(alwaysBounceHorizontal)),
          alwaysBounceVertical: Js_undefined.fromOption(UtilsRN$BsReactNative.optBoolToOptJsBoolean(alwaysBounceVertical)),
          automaticallyAdjustContentInsets: Js_undefined.fromOption(UtilsRN$BsReactNative.optBoolToOptJsBoolean(automaticallyAdjustContentInsets)),
          bounces: Js_undefined.fromOption(UtilsRN$BsReactNative.optBoolToOptJsBoolean(bounces)),
          canCancelContentTouches: Js_undefined.fromOption(UtilsRN$BsReactNative.optBoolToOptJsBoolean(canCancelContentTouches)),
          centerContent: Js_undefined.fromOption(UtilsRN$BsReactNative.optBoolToOptJsBoolean(centerContent)),
          contentInset: Js_undefined.fromOption(contentInset),
          contentOffset: Js_undefined.fromOption(UtilsRN$BsReactNative.option_map((function (param) {
                      return {
                              x: param[/* x */0],
                              y: param[/* y */1]
                            };
                    }), contentOffset)),
          decelerationRate: Js_undefined.fromOption(UtilsRN$BsReactNative.option_map((function (x) {
                      if (x >= 812216871) {
                        return "normal";
                      } else {
                        return "fast";
          ...
          directionalLockEnabled: Js_undefined.fromOption(UtilsRN$BsReactNative.optBoolToOptJsBoolean(directionalLockEnabled)),
          indicatorStyle: Js_undefined.fromOption(UtilsRN$BsReactNative.option_map((function (x) {
                      if (x !== 465819841) {
                        if (x >= 888264127) {
                          return "black";
                        } else {
          ...
          scrollsToTop: Js_undefined.fromOption(UtilsRN$BsReactNative.optBoolToOptJsBoolean(scrollsToTop)),
          snapToAlignment: Js_undefined.fromOption(UtilsRN$BsReactNative.option_map((function (x) {
                      if (x !== 67859554) {
                        if (x >= 98248149) {
                          return "center";
                        } else {
