...
function serialize(handlers) {
  if (handlers) {
    ...
    return {
            onMoveShouldSetResponder: Js_undefined.fromOption(UtilsRN$BsReactNative.option_map((function (g, x) {
                        return Curry._1(g, x);
                      }), handlers$1[/* onMoveShouldSetResponder */0])),
            onMoveShouldSetResponderCapture: Js_undefined.fromOption(UtilsRN$BsReactNative.option_map((function (g, x) {
                        return Curry._1(g, x);
            ...
            onStartShouldSetResponder: Js_undefined.fromOption(UtilsRN$BsReactNative.option_map((function (g, x) {
                        return Curry._1(g, x);
                      }), handlers$1[/* onStartShouldSetResponder */8])),
            onStartShouldSetResponderCapture: Js_undefined.fromOption(UtilsRN$BsReactNative.option_map((function (g, x) {
                        return Curry._1(g, x);
...
function extendView(onMouseEnter, onMouseLeave, accessibilityLabel, accessible, hitSlop, onAccessibilityTap, onLayout, onMagicTap, responderHandlers, pointerEvents, removeClippedSubviews, style, testID, accessibilityComponentType, accessibilityLiveRegion, collapsable, importantForAccessibility, needsOffscreenAlphaCompositing, renderToHardwareTextureAndroid, accessibilityTraits, accessibilityViewIsModal, shouldRasterizeIOS, moreProps) {
  return Object.assign({
              ...
              pointerEvents: Js_undefined.fromOption(UtilsRN$BsReactNative.option_map((function (x) {
                          if (x >= 416112227) {
                            if (x >= 427151639) {
                              return "box-only";
                            } else {
              ...
              accessibilityLiveRegion: Js_undefined.fromOption(UtilsRN$BsReactNative.option_map((function (x) {
                          if (x !== -114955603) {
                            if (x >= 536661202) {
                              return "assertive";
                            } else {
              ...
              collapsable: Js_undefined.fromOption(UtilsRN$BsReactNative.optBoolToOptJsBoolean(collapsable)),
              importantForAccessibility: Js_undefined.fromOption(UtilsRN$BsReactNative.option_map((function (prop) {
                          if (prop >= 24641) {
                            if (prop >= 6039847) {
                              return "yes";
                            } else {
              ...
              needsOffscreenAlphaCompositing: Js_undefined.fromOption(UtilsRN$BsReactNative.optBoolToOptJsBoolean(needsOffscreenAlphaCompositing)),
              renderToHardwareTextureAndroid: Js_undefined.fromOption(UtilsRN$BsReactNative.optBoolToOptJsBoolean(renderToHardwareTextureAndroid)),
              ...
              accessibilityViewIsModal: Js_undefined.fromOption(UtilsRN$BsReactNative.optBoolToOptJsBoolean(accessibilityViewIsModal)),
              shouldRasterizeIOS: Js_undefined.fromOption(UtilsRN$BsReactNative.optBoolToOptJsBoolean(shouldRasterizeIOS))
